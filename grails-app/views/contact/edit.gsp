    ...
    <body>
        ...
        <div id="edit-contact" class="content scaffold-edit" role="main">
            ...
            <g:form resource="${this.contact}" method="PUT">
                ...
                <fieldset class="form">
                    <f:field bean="contact" property="name"/>
                    <f:field bean="contact" property="surname"/>
                    <label for="birthday">Birthday</label>
                    <g:datePicker name="birthday" value="${contact.birthday}" noSelection="['':'-Choose-']" precision="day"/>
                </fieldset>
